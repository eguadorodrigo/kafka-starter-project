...
import br.com.eguadorodrigo.kafkastarterproject.service.FraudDetectorService;
...
@Configuration
public class FraudDetectorConsumerConfig {
    public ConsumerFactory<String, String> emailConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, GlobalConstants.FRAUD_GROUP_ID);
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, FraudDetectorService.class);
